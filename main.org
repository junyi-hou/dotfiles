...
#+begin_src nix :noweb-ref emacsOverlayVersion
  emacsOverlayHash = "3f8a3e6f49d2ba4ce6ca03d7c359550d53ab5de7";
#+end_src
...
#+begin_src emacs-lisp :tangle no :noewb-ref r-init
  (defun gatsby:install-and-load-tree-sitter-r ()
...
#+begin_src emacs-lisp :tangle no :noweb-ref r-hook
  (ess-r-mode . gatsby:install-and-load-tree-sitter-r)
#+end_src
...
** ein: freezes ~emacs~
** check consult native-comp status
 see https://debbugs.gnu.org/cgi/bugreport.cgi?bug=47868 and https://github.com/minad/vertico/issues/15
