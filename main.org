...
#+author: Junyi Hou
#+property: header-args:emacs-lisp :tangle ./emacs.d/init.el :mkdirp yes :noweb yes :comments both
#+property: header-args:nix :mkdirp yes :noweb yes :comments both
#+startup: show3levels
#+options: toc:3
...
#+begin_src nix :noweb-ref home-manager :noweb yes
  ...
  home.packages = [ gitAndTools.delta ];
#+end_src
...
#+begin_src nix :noweb-ref home-manager
  home.packages = with pkgs; [
    (python38.withPackages (p: with p; [ jupyter ]))
  ];
#+end_src
