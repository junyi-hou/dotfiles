...
#+begin_src nix :noweb-ref home-manager :noweb yes
  {
    ...
    home.file.".config/fontconfig/conf.d/90-emacs-fonts".text = ''
    <<emacs-font-config>>
    '';
  }
#+end_src

I use ~fontconfig~ to "glue" different fonts together to cover different character sets. Specifically, I define a font named ~emacs-font~ and aliasing all other fonts (covering different character sets) I plan to use in ~emacs~ under it.

#+begin_src xml :noweb-ref emacs-font-config
  <?xml version='1.0'?>
  <fontconfig>
    <alias binding="same">
      <family>emacs-font</family>
      <prefer>
        <family>Iosevka Term</family>
        <family>SourceHanSansCN</family>
        <family>SourceHanSansTW</family>
        <family>SourceHanSansJP</family>
        <family>SourceHanSansKR</family>
